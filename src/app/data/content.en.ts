...
export const CONTENT_EN: PortfolioContent = {
  ...
  projects: [
    ...
    },
    {
      title: 'Portfolio',
      summary:
        "Personal portfolio to showcase my projects and skills.\\n__Objective:__ To present my profile through a showcase website\\__Features:__ Responsive website built with Angular, integration of dynamic content, implementation of a modular architecture and a seamless navigation system.",
  ...
  school: [
    ...
    {
      diplome:
        '[High school diploma] General (Mathematics, Computer Science, Physics and Chemistry) **Good grade**',
